...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen md:h-screen flex flex-col relative" style={{ backgroundColor: "oklch(1 0 0)" }}>
      {/* Logo - fixed position */}
      ...
      <main className="flex-1 flex flex-col md:grid md:grid-cols-2">
        ...
        <div className="flex flex-col justify-center items-center md:items-start text-center md:text-left px-6 pt-32 pb-0 md:px-16 lg:px-24 md:py-0 md:justify-center space-y-4 md:space-y-6">
          ...
          <p className="text-sm md:text-lg lg:text-xl leading-relaxed text-pretty max-w-lg md:hidden" style={{ color: "oklch(0.40 0.01 150)" }}>
          ...
          {/* Waitlist Form */}
          <div className="w-full max-w-lg mt-1 md:mt-0">
            <form
            ...
            >
              <div className="relative">
                <input
                  ...
                  className="w-full h-10 md:h-14 px-3 md:px-6 pr-20 md:pr-36 text-xs md:text-base rounded-full transition-all focus:border-[oklch(0.75_0.06_150)]"
                  style={{
                    border: "2px solid oklch(0.85 0.01 150)",
                    backgroundColor: "oklch(0.995 0.008 145 / 0.5)",
                    color: "oklch(0.25 0.01 150)",
      ...
      <footer className="border-t py-2 md:py-4" style={{ borderColor: "oklch(0.90 0.01 150 / 0.4)" }}>
        <p className="text-center text-xs md:text-sm leading-tight" style={{ color: "oklch(0.50 0.01 150)" }}>
